...
<nav id="mainNav" class="fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-transparent">
    ...
    <div class="container mx-auto px-4 sm:px-8 py-3 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center gap-2">
            ...
            <a href="/login"
                class="ml-3 relative overflow-hidden bg-white text-teal-700 px-6 py-2.5 rounded-xl font-bold text-sm shadow-lg shadow-white/20 hover:shadow-xl hover:shadow-white/30 hover:scale-105 transition-all duration-300 group">
        ...
        <!-- MOBILE HAMBURGER -->
        <button id="nav-toggle" class="md:hidden flex flex-col gap-1.5 p-2.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300" aria-label="Menu">
