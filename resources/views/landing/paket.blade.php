...
<section class="bg-white py-20">
    <div class="container mx-auto px-6 max-w-4xl reveal">
        <div class="text-center mb-12">
            <h2 class="text-3xl sm:text-4xl font-black text-gray-900 mb-4">Pertanyaan Seputar <span class="gradient-text">Paket</span></h2>
            <p class="text-gray-500">Temukan jawaban untuk pertanyaan yang sering ditanyakan pelanggan kami.</p>
        </div>

        <div class="space-y-4">
            <!-- Item 1 -->
            <div class="border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <h3 class="text-lg font-bold text-gray-800 mb-2">Apakah ada biaya pemasangan?</h3>
                <p class="text-gray-600 text-sm leading-relaxed">Gratis biaya instalasi dan peminjaman perangkat router selama berlangganan.</p>
            </div>
            <!-- Item 2 -->
            <div class="border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <h3 class="text-lg font-bold text-gray-800 mb-2">Apakah ada batasan kuota (FUP)?</h3>
                <p class="text-gray-600 text-sm leading-relaxed">Semua paket kami adalah Unlimited tanpa FUP. Anda bebas menggunakan internet tanpa khawatir kecepatan turun atau kuota habis.</p>
            </div>
            <!-- Item 3 -->
            <div class="border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <h3 class="text-lg font-bold text-gray-800 mb-2">Berapa lama proses pemasangan?</h3>
                <p class="text-gray-600 text-sm leading-relaxed">Proses pemasangan bisa dilakukan pada hari yang sama atau maksimal H+1 setelah pendaftaran dan survei lokasi disetujui.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="reveal">
            <div class="relative rounded-[2.5rem] overflow-hidden max-w-5xl mx-auto shadow-2xl">
                ...
                <div class="relative p-10 sm:p-16 text-center">
                    ...
                    <p class="text-lg text-teal-50 mb-10 max-w-2xl mx-auto">Dapatkan promo menarik khusus pemasangan bulan ini. Segera hubungi admin kami.</p>
