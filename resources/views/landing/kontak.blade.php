...
<section class="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-slate-900 via-teal-900 to-cyan-900">
    <div class="absolute inset-0">
        <div class="absolute top-1/2 left-1/2 w-[600px] h-[600px] bg-gradient-to-br from-teal-400/20 to-emerald-400/10 rounded-full blur-[100px] -translate-x-1/2 -translate-y-1/2 animate-aurora"></div>
    </div>
...
<!-- KONTAK & MAPS -->
<section class="container mx-auto px-6 py-20 -mt-1">
        ...
        <div class="reveal reveal-delay-1">
            ...
            <div class="bg-white rounded-[2rem] p-8 shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden group hover:shadow-teal-500/10 transition-all duration-300">
                ...
                <div class="flex items-center gap-5 mb-10">
                    <div class="w-16 h-16 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-teal-500/30">
                ...
                <div class="space-y-6">
                    <div class="flex items-center gap-5 p-4 rounded-2xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                ...
                <a href="https://wa.me/6281929442611?text=Halo%20Admin%20Starconnect" target="_blank"
                    class="mt-10 w-full group overflow-hidden relative bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-6 py-4 rounded-2xl font-bold shadow-lg shadow-teal-500/30 hover:shadow-xl hover:shadow-teal-500/40 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3">
        ...
        <div class="reveal reveal-delay-2 h-full flex flex-col">
            ...
            <div class="bg-white rounded-[2rem] p-3 shadow-xl shadow-gray-200/50 border border-gray-100 flex-1 min-h-[400px]">
                <iframe 
                    ...
                    class="w-full h-full rounded-[1.5rem] grayscale-[0.2] contrast-[1.1]" 
                    style="border:0;" 
                    allowfullscreen="" 
                    loading="lazy" 
