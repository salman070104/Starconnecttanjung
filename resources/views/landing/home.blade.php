...
<section class="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-900 via-teal-900 to-cyan-900">
    ...
    <div class="relative container mx-auto px-6 pt-28 pb-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="animate-fadeInUp">
            ...
            <p class="mt-8 text-lg sm:text-xl text-white/60 leading-relaxed max-w-lg">
    ...
    <div class="container mx-auto px-6">
        <div class="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 reveal">
            ...
            <div class="bg-white rounded-2xl p-6 text-center shadow-lg shadow-gray-100/80 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p class="text-sm text-gray-400 font-medium mt-1">Pelanggan Aktif</p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 text-center shadow-lg shadow-gray-100/80 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p class="text-sm text-gray-400 font-medium mt-1">Uptime Jaringan</p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 text-center shadow-lg shadow-gray-100/80 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p class="text-sm text-gray-400 font-medium mt-1">Support Online</p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 text-center shadow-lg shadow-gray-100/80 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p class="text-sm text-gray-400 font-medium mt-1">Kecepatan Max</p>
            </div>
...
<section class="bg-gray-50 py-20 sm:py-28">
    <div class="container mx-auto px-6 max-w-6xl">
        ...
        <div class="text-center mb-16 reveal">
            <p class="text-sm font-bold text-teal-600 uppercase tracking-widest mb-3">Keunggulan Kami</p>
            ...
            <p class="mt-5 text-gray-400 text-lg max-w-2xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="reveal reveal-delay-1 group">
                <div class="bg-white rounded-3xl p-8 shadow-lg shadow-gray-100/80 border border-gray-100 hover:shadow-2xl hover:shadow-teal-500/10 hover:-translate-y-2 transition-all duration-500 h-full">
                    ...
                    <h3 class="text-2xl font-black text-gray-800 mb-3">Sangat Stabil</h3>
            ...
            <div class="reveal reveal-delay-2 group">
                <div class="bg-white rounded-3xl p-8 shadow-lg shadow-gray-100/80 border border-gray-100 hover:shadow-2xl hover:shadow-cyan-500/10 hover:-translate-y-2 transition-all duration-500 h-full">
                    ...
                    <h3 class="text-2xl font-black text-gray-800 mb-3">Super Cepat</h3>
                    <p class="text-gray-500 leading-relaxed">
            ...
            <div class="reveal reveal-delay-3 group">
                <div class="bg-white rounded-3xl p-8 shadow-lg shadow-gray-100/80 border border-gray-100 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 transition-all duration-500 h-full">
                    ...
                    <h3 class="text-2xl font-black text-gray-800 mb-3">Harga Terjangkau</h3>
                    <p class="text-gray-500 leading-relaxed">
    ...
    <div class="container mx-auto px-6 max-w-6xl">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal reveal-delay-2">
                <p class="text-sm font-bold text-teal-600 uppercase tracking-widest mb-4">Perangkat Berkualitas</p>
                <h2 class="text-4xl sm:text-5xl font-black text-gray-900 leading-tight mb-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4">
                        ...
                        <p class="text-gray-600 font-medium">Didukung teknisi profesional Star Connect</p>
                    </div>
                    <div class="flex items-center gap-4">
                        ...
                        <p class="text-gray-600 font-medium">Layanan support siap membantu kapan saja</p>
                    </div>
                    <div class="flex items-center gap-4">
                        ...
                        <p class="text-gray-600 font-medium">Gratis instalasi dan setting router</p>
                    </div>
                </div>
            </div>
...
<section class="relative bg-gradient-to-b from-gray-50 to-white py-20 sm:py-28 overflow-hidden">
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="text-center mb-16 reveal">
            <p class="text-sm font-bold text-teal-600 uppercase tracking-widest mb-3">Pilihan Paket</p>
            <h2 class="text-4xl sm:text-5xl font-black text-gray-900 leading-tight">
            ...
            <div class="reveal reveal-delay-{{ ($i % 5) + 1 }} group">
                <div class="relative bg-white rounded-3xl shadow-lg shadow-gray-100/80 border {{ $paket['popular'] ? 'border-amber-300 ring-2 ring-amber-400/30' : 'border-gray-100' }} overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 h-full flex flex-col">
                    ...
                    <div class="p-6 text-center flex-1 flex flex-col">
                        ...
                        <p class="text-gray-400 text-xs mb-6">per bulan</p>
...
<section class="bg-white py-20 sm:py-28">
    <div class="container mx-auto px-6 max-w-6xl">
        ...
        <div class="text-center mb-16 reveal">
            <p class="text-sm font-bold text-teal-600 uppercase tracking-widest mb-3">Testimoni</p>
            <h2 class="text-4xl sm:text-5xl font-black text-gray-900 leading-tight">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="reveal reveal-delay-1">
                <div class="bg-gray-50 rounded-3xl p-8 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full">
                    ...
                    <p class="text-gray-600 leading-relaxed mb-6">"Internet nya mantap, stabil banget buat kerja dari rumah. Streaming juga lancar, gak pernah buffering. Recommended!"</p>
            ...
            <div class="reveal reveal-delay-2">
                <div class="bg-gray-50 rounded-3xl p-8 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full">
                    ...
                    <p class="text-gray-600 leading-relaxed mb-6">"Harga terjangkau tapi kualitas top. Anak-anak bisa belajar online, saya juga bisa meeting video call tanpa masalah."</p>
                    <div class="flex items-center gap-3">
            ...
            <div class="reveal reveal-delay-3">
                <div class="bg-gray-50 rounded-3xl p-8 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full">
                    ...
                    <p class="text-gray-600 leading-relaxed mb-6">"Gaming pake Star Connect anti lag. Main Mobile Legend, PUBG, Free Fire lancar jaya. Support nya juga fast response banget!"</p>
                    <div class="flex items-center gap-3">
